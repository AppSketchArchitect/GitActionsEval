  ...
  try {
    ...
    await RequestType.insertMany([
      ...
      },
      {
        ...
        description:
          "Question sur l'utilisation de la facturation en général sur l'application.",
        priority: 'low',
        category: 'SUPPORT',
      ...
      },
      {
        ...
        description:
          "Demande de fonctionnalité lié à une problématique d'utilisation dans l'application.",
        priority: 'low',
        category: 'TECHNICAL',
